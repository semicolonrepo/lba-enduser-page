                ...
                @if($fbLink != '')
                  <div class="category-item">
                    <div class="category-item__image">
                      <a href="{{ $fbLink }}" id="checkLink" target="_blank">
                  ...
                  <div class="category-item">
                    <div class="category-item__image">
                      <a href="{{ $igLink }}" id="checkLink" target="_blank">
                  ...
                  <div class="category-item">
                    <div class="category-item__image">
                      <a href="{{ $xLink }}" id="checkLink" target="_blank">
                  ...
                  <div class="category-item">
                    <div class="category-item__image">
                      <a href="{{ $tokLink }}" id="checkLink" target="_blank">
                  ...
                  <div class="category-item">
                    <div class="category-item__image">
                      <a href="{{ $webLink }}" id="checkLink" target="_blank">
