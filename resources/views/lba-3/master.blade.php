...
<head>
  ...
  <!-- CSS ============================================ -->
  <!-- Bootstrap CSS -->
  <link rel="stylesheet" href="{{ asset('assets/lba-3/css/bootstrap.min.css') }}">
  <!-- FontAwesome CSS -->
  <link rel="stylesheet" href="{{ asset('assets/lba-3/css/font-awesome.min.css') }}">
  <!-- Slick CSS -->
  <link rel="stylesheet" href="{{ asset('assets/lba-3/css/plugins/slick.min.css') }}">
  <!-- Animate CSS -->
  <link rel="stylesheet" href="{{ asset('assets/lba-3/css/plugins/cssanimation.min.css') }}">
  <!-- IonRange slider CSS -->
  <link rel="stylesheet" href="{{ asset('assets/lba-3/css/plugins/ion.rangeSlider.min.css') }}">
  ...
  <!--
			...
			-->
  <!-- Main Style CSS -->
  <link rel="stylesheet" href="{{ asset('assets/lba-3/css/style.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/lba-3/css/custom.css') }}">
...
@endif
  ...
  <!-- JS
    ============================================ -->
  <!-- Modernizer JS -->
  <script src="{{ asset('assets/lba-3/js/modernizr-2.8.3.min.js') }}"></script>
  <!-- jQuery JS -->
  <script src="{{ asset('assets/lba-3/js/jquery.min.js') }}"></script>
  <!-- Bootstrap JS -->
  <script src="{{ asset('assets/lba-3/js/bootstrap.min.js') }}"></script>
  <!-- IonRanger JS -->
  <script src="{{ asset('assets/lba-3/js/plugins/ion.rangeSlider.min.js') }}"></script>
  <!-- SVG inject JS -->
  <script src="{{ asset('assets/lba-3/js/plugins/svg-inject.min.js') }}"></script>
  <!-- Slick slider JS -->
  <script src="{{ asset('assets/lba-3/js/plugins/slick.min.js') }}"></script>
  ...
  <!-- Main JS -->
  <script src="{{ asset('assets/lba-3/js/main.js') }}"></script>
  <script src="{{ asset('assets/lba-3/js/colorUtils.js') }}"></script>
  <script src="{{ asset('assets/lba-3/js/select-partner.js') }}"></script>
  <script>
