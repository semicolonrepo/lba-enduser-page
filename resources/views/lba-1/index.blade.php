...
<div style="background-color: green !important"> <!-- use primary color for header -->
        ...
        <div class="col-12">
          <div class="hero-slider-wrapper">
            <div class="hero-slider-item d-flex bg-img"
              data-bg="{{ asset('assets/lba-1/img/hero-slider/slider-1.jpg') }}">
              <div class="container">
                <div class="row">
                  <div class="col-12">
                    <!-- hero slider content -->
                    <div class="hero-slider-content">
                      <p class="hero-slider-content__text">Text Banner</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="hero-slider-item d-flex bg-img"
              data-bg="{{ asset('assets/lba-1/img/hero-slider/slider-2.jpg') }}">
              <div class="container">
                <div class="row">
                  <div class="col-12">
                    <!-- hero slider content -->
            ...
            <div class="hero-slider-item d-flex bg-img"
              data-bg="{{ asset('assets/lba-1/img/hero-slider/slider-3.jpg') }}">
              <div class="container">
                <div class="row">
                  <div class="col-12">
                    <!-- hero slider content -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
          ...
          <!-- If in header have Bio -->
          <div class="category-slider-wrapper">
            <div class="category-item">
              <div class="category-item__image">
                <a href="https://facebook.com" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#3b5998" class="bi bi-facebook" viewBox="0 0 16 16">
            ...
            <div class="category-item">
              <div class="category-item__image">
                <a href="https://instagram.com" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#E1306C" class="bi bi-instagram" viewBox="0 0 16 16">
            ...
            <div class="category-item">
              <div class="category-item__image">
                <a href="https://letsbuyasia.com" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="black" class="bi bi-globe2" viewBox="0 0 16 16">
          ...
          <p class="text-center space-mt--10 space-mb--20">
            <a href="https://google.com" target="_blank" class="text-white text-decoration-underline section-title">
              Link Name Here
            </a>
          </p>
        </div>
          ...
          <div class="row row-10">
            ...
            <div class="col-6">
              <div class="grid-product space-mb--20">
                <div class="grid-product__image">
                  <a href="{{ route('lba-1::product', ['brand' => $brand, 'campaign' => $campaign]) }}">
                    <img src="{{ asset('assets/lba-1/img/products/product1.png') }}" class="img-fluid" alt="">
                  </a>
                </div>
                <div class="grid-product__content">
                  <h3 class="title"><a href="{{ route('lba-1::product', ['brand' => $brand, 'campaign' => $campaign]) }}">Promo Produk 1</a></h3>
            ...
            <div class="col-6">
              <div class="grid-product space-mb--20">
                ...
                <div class="grid-product__content">
                  <h3 class="title"><a href="{{ route('lba-1::product', ['brand' => $brand, 'campaign' => $campaign]) }}">Promo Produk 2</a></h3>
                  <div class="price space-mt--10">
                    <span class="discounted-price">Tawaran Menarik</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-6">
              <div class="grid-product space-mb--20">
                ...
                <div class="grid-product__content">
                  <h3 class="title"><a href="{{ route('lba-1::product', ['brand' => $brand, 'campaign' => $campaign]) }}">Promo Produk 3</a></h3>
                  <div class="price space-mt--10">
                    <span class="discounted-price">gratis</span>
                  </div>
                </div>
